	 ...
	 $.ajax({    //create an ajax request to display.php
      ...
      /*          '<td><div class="form-group">'+
              ...
              '  <div     id="row_event_aboutus_'+response[y].id+'"   > '+  (response[y].about_us?response[y].about_us:'') +'</div></div></div></td>'+*/
                ...
                ' <div class="col-sm-12">'+
              '  <div id="row_event_start_'+response[y].id+'" > '+  (response[y].event_start_date?response[y].event_start_date:'') +'</div></div> '+
              '</div> </div></td>'+
              ...
              '<td><div class="form-group"><div class="input-group" id="eventEndDateDIV_'+response[y].id+'" >'+
                ' <div class="col-sm-12">'+
              '  <div  id="row_event_end_'+response[y].id+'" > '+  (response[y].event_end_date?response[y].event_end_date:'') +'</div></div> '+
              '</div> </div></td>'+
    	 ...
    	 if(($("#event_name").val().trim()!='') || ($("#event_venue").val().trim()!='') || ($("#eventStartDate").val().trim()!='') || ($("#eventStartTime").val().trim()!='')
		 	...
		 	$.ajax({    //create an ajax request to display       
		        ...
		        //	console.log("timestamp ="+timestamp);
		        	 var sDate = response[0].event_start_date;
		        ...
		        //	$('#eventStartDate').datetimepicker('update', sDate);
		          ...
		          $("#eventEndDate").val(""+(response[0].event_end_date?response[0].event_end_date:"")); 
