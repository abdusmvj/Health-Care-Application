...
<div class="panel panel-default">				
 ...
 <div  id="show-list-table-div" class="table table-hover">
		<table
			...
			<thead>
				<tr>
					...
					<th  width="22%">Schedule Name<span class="js-sorter-desc glyphicon glyphicon-chevron-down pull-right custom-glyphicon"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right custom-glyphicon"></span></th>
					<th  width="26%">Description<span class="js-sorter-desc glyphicon glyphicon-chevron-down pull-right custom-glyphicon"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right custom-glyphicon"></span></th>
	...
	<!-- form container create here -->
		...
		<form class="form-horizontal" id="participantScheduleForm" modelAttribute="scheduleModel">
				   ...
				   <div class="row">
                     ...
                     <div class="col-lg-6" >
                      <div class='input-group date'  id='schedule_starttimeDIV' >
                       <input type='text' class="form-control"  id="schedule_starttime" placeholder="Schedule Start Time" name="schedule_starttime" />
                       <span class="input-group-addon">
