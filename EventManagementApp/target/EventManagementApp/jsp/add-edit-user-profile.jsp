...
<!--  <div class="panel panel-default">  -->
  ...
  <form class="form-inline" id="updateediteduser" >
...
<div class="form-group  col-sm-12">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" id="user_phone" placeholder="Phone" name="user_phone"/>
      </div>
    </div>
  	        ...
  	        fields: {
	            ...
	            user_phone: {
	                   validators: {
	                    ...
	                    stringLength: {
	                        max:100,
	                        message: 'The phone must be less than 100 characters'
