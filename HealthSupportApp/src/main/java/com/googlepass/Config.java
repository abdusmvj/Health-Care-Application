...
//        this.SERVICE_ACCOUNT_EMAIL_ADDRESS = "svc-asda-mci@asda-toyou-mci.iam.gserviceaccount.com"; // CHANGEME
//        this.SERVICE_ACCOUNT_FILE = String.format("src/main/resources/%s", "private.json"); // CHANGEME. Path to file with private key and Google credential config
//
