...
//            System.out.println("abdus =3:"+credentials.getServiceAccountPrivateKeyId());
//            System.out.println("abdus =3:"+credentials.getServiceAccountId());
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
...
//                .build();
//        System.out.println("Offer class value json :"+offerClass);
//        System.out.println("jsonfacotry class value json :"+jsonFactory);
//        System.out.println("Client class value json :"+client);
//
//        try {
//            response = client.offerclass().insert(offerClass).execute();
//            response.put("code",200);
//             System.out.println("Google success response == "+response);
