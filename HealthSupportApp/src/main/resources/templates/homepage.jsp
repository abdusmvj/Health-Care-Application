...
<div class="container">
		<% if(session.getAttribute("success-msg") != null) { %>
		<div class="alert alert-warning text-center" style="margin-top:5px; margin-bottom:5px;">
			<a href="#" class="close" data-dismiss="alert"> &times;</a>
			<%=session.getAttribute("success-msg")%>
		</div>
